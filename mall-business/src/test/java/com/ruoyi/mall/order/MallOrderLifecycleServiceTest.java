...
class MallOrderLifecycleServiceTest
{
    ...
    void setUp()
    {
        ...
        service = new MallOrderLifecycleService(mapper, inventoryPort);
    ...
    void timeoutClosesOnlyExpiredUnpaidOrders()
    {
        ...
        when(mapper.selectTimeoutCandidates(any(LocalDateTime.class), anyInt())).thenReturn(List.of(candidate));
