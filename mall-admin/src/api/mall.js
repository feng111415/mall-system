...
export const getInventories = params => http.get('/mall/inventory/list', { params })
export const getInventoryLogs = (skuId, params) => http.get(`/mall/inventory/${skuId}/logs`, { params })
export const adjustInventory = (skuId, data) => http.put(`/mall/inventory/${skuId}/adjust`, data)
